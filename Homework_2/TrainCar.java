...
/**
 * Contains the length and weight of the car. Acts as a wrapper/extention of
 * ProductLoad, but doesn't actually extend it.
 * 
...
public class TrainCar {
     ...
     * The load variable is also set to null and can be changed using the
     * setLoad() mutator.
     * 
     ...
     * 
     * @return true if load is null/empty false is load has an ProductLoad
     *         inside of it
     */
     ...
     *                                  or is negative
     */
    public static boolean validLength(Object obj)
                                        throws IllegalArgumentException
    {
        if (obj instanceof Double) {
        ...
        throw new IllegalArgumentException(
                            "The given length not an instance of double");
    }
     ...
     *                                  instance of ProductLoad. There is no
     *                                  need to run futher checks because in
     *                                  order for a new ProductLoad to be
     *                                  instatiated, it must have already go
     *                                  through the valid checkers
     */
    public static boolean validLoad(Object obj) throws IllegalArgumentException
    {
        ...
        throw new IllegalArgumentException(
                    "The given Object not an instance of ProductLoad");
    }
}

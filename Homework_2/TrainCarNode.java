...
public class TrainCarNode {
    ...
    public String toString() {
        ...
        return String.format("%10f    %10f  | %25s    %10f    %10f   %s", car.getCarLength(), car.getCarWeight(),
                car.getLoad().getName(), car.getLoad().getWeight(), car.getLoad().getValue(), isDangerousString);
    }
}